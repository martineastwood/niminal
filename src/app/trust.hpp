...
std::vector<std::filesystem::path> project_trust_resources(
    const std::filesystem::path& workspace);
bool project_resources_trusted(const std::filesystem::path& workspace);
void set_project_resources_trusted(const std::filesystem::path& workspace,
                                   bool trusted);
void save_project_trust(const std::filesystem::path& workspace, bool trusted);
ProjectTrust resolve_project_trust(
    const std::filesystem::path& workspace,
