...
std::vector<ProviderSpec>& provider_registry() {
  static std::vector<ProviderSpec> providers = {
    ...
    {"google", "https://generativelanguage.googleapis.com/v1beta", "gemini-3.5-flash-lite",
     {"GEMINI_API_KEY", "GOOGLE_API_KEY", "GOOGLE_GENERATIVE_AI_API_KEY"}, "generativelanguage.googleapis.com", false, false, false, false},
    {"foundry", "", "gpt-5.4", {"AZURE_FOUNDRY_API_KEY"}, "cognitiveservices.azure.com/openai/responses", false,
     false, false, false},
    ...
    {"mistral", "https://api.mistral.ai/v1/chat/completions", "mistral-vibe-cli-with-tools",
     {"MISTRAL_API_KEY"}, "api.mistral.ai", false, false, false, true},
    {"openai", "https://api.openai.com/v1/chat/completions", "gpt-5", {"OPENAI_API_KEY"}, "api.openai.com",
     false, true, false, true},
    {"ollama", "https://ollama.com/v1/chat/completions", "gemma4:31b", {"OLLAMA_API_KEY"}, "ollama.com",
     false, true, false, false},
    {"opencode", "https://opencode.ai/zen/go/v1/chat/completions", "deepseek-v4.1-flash",
     {"OPENCODE_API_KEY"}, "opencode.ai/zen/go", false, false, false, false},
    {"opencodezen", "https://opencode.ai/zen/v1/chat/completions", "deepseek-v4-flash",
     {"OPENCODE_API_KEY"}, "opencode.ai", false, false, true, false},
    {"openrouter", "https://openrouter.ai/api/v1/chat/completions", "openai/gpt-4o-mini",
     {"OPENROUTER_API_KEY"}, "openrouter.ai", true, true, true, true},
  };
  return providers;
}
